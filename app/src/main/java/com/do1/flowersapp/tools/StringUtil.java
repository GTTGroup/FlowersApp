...
public class StringUtil {
    ...
    // add by cbl 2013.4.1 begin
    /**
     *
     * 从text中截取length个字符，如果text的长度，超过length，则在截取后的结果中，添加endWith的标识
     * @param text 需要截取的字符串
     * @param length 需要截取的字符串长度
     * @param endWith 截取后，为字符串添加的后缀
     * @return 截取后的结果
     */
    ...
    * @return
    ...
    public static String addParamUrl(String url, String appendParam){
        if(url == null){
            return url;
        }
